...
def load_data():
    ...
    schools   = pd.read_csv("schools.csv",   sep=";")  # label;lon;lat
    addresses = pd.read_csv("addresses.csv", sep=";")  # address;lon;lat
